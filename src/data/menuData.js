...
export const MENU_ITEMS = [
  ...
  { id: 'min-04', categoryId: 'minutas', name: 'Milanesa de carne', description: 'Con guarnición.', price: 730, tags: [] },
  { id: 'min-05', categoryId: 'minutas', name: 'Milanesa de pollo', description: 'Con guarnición.', price: 730, tags: [] },
  { id: 'min-06', categoryId: 'minutas', name: 'Milanesa Napolitana', description: 'Muzzarella fundida, jamón, salsa de tomate y orégano, con guarnición.', price: 780, tags: [] },
  { id: 'min-07', categoryId: 'minutas', name: 'Milanesa a caballo', description: 'Con dos huevos fritos y guarnición.', price: 780, tags: [] },
  { id: 'min-08', categoryId: 'minutas', name: 'Milanesa tres quesos', description: 'Gratinada con muzzarella, provolone, roquefort y pimientos asados, con guarnición.', price: 780, tags: [] },
  { id: 'min-09', categoryId: 'minutas', name: 'Milanesa de la casa', description: 'Cheddar, panceta, cebolla caramelizada y verdeo, con guarnición.', price: 800, tags: [] },
  ...
  { id: 'bra-07', categoryId: 'brasas', name: 'Entraña', description: '', price: 850, tags: [] },
  { id: 'bra-08', categoryId: 'brasas', name: 'Picaña de cordero', description: '', price: 820, tags: [] },
  { id: 'bra-09', categoryId: 'brasas', name: 'Asado premium', description: '', price: 850, tags: [] },
  { id: 'bra-10', categoryId: 'brasas', name: 'Bife de vacío', description: '', price: 780, tags: [] },
  { id: 'bra-11', categoryId: 'brasas', name: 'Bife ancho', description: 'Baby beef.', price: 850, tags: [] },
  { id: 'bra-12', categoryId: 'brasas', name: 'Matambrito de cerdo', description: '', price: 740, tags: [] },
  { id: 'bra-13', categoryId: 'brasas', name: 'Pamplona de pollo', description: 'Jamón, muzzarella, olivas y pimientos.', price: 690, tags: [] },
  { id: 'bra-14', categoryId: 'brasas', name: 'Pollo a las brasas', description: 'Muslo deshuesado o pechuga. Opcional salsa de mostaza y miel.', price: 620, tags: [] },
  ...
  { id: 'mar-02', categoryId: 'mar', name: 'Pesca con manteca de hierbas', description: '', price: 790, tags: [] },
  { id: 'mar-03', categoryId: 'mar', name: 'Pesca cítrica', description: 'Grillada con un suave pesto cítrico.', price: 810, tags: [] },
  { id: 'mar-04', categoryId: 'mar', name: 'Pesca Arrecife', description: 'Grillada con crema de camarones, roquefort y puerro.', price: 890, tags: [] },
  { id: 'mar-05', categoryId: 'mar', name: 'Pesca toscana', description: 'Grillada con salsa fresca de tomate, olivas negras, albahaca, muzzarella de búfala, alcaparras y tomates secos.', price: 850, tags: [] },
